...
/** Dashboard variant showing steering angle instead of speed. */
public class DashboardScreen2 implements ClusterPlugin {

    public DashboardScreen2() {}
    ...
    private static class DashboardView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            // Row 0: Steering angle | Brake pedal
            float y0 = mRowH * 0;
            String steerStr = !Double.isNaN(mSnapshot.steering.angleDeg)
                    ? mSnapshot.steering.angleDeg + " deg" : "--";
            drawCell(canvas, steerStr, "STEER", mOnPaint, mPad, y0);
